...
export default function Home() {
  return (
    <div className="justify-center mx-auto px-8 py-12 max-w-screen-sm space-y-2 flex-grow text-black dark:text-white">      <div className="flex space-x-8 items-center pb-4">
      <img
        src="/pfp.jpeg"
        alt=""
        width={120}
      ...
      <div className="justify-items-right">
        <h1 className="text-4xl text-black dark:text-white font-extrabold font-serif">          Sidharth Baskaran
        </h1>
      ...
      <h1 className="text-lg font-bold dark:text-gray-300">About</h1>
      <p className="text-left text-gray-600 dark:text-gray-300 text-sm">
        I study Computer Science at Georgia Tech 🐝 with concentrations in systems & architecture and theory.
      </p>
      <p className="text-left text-gray-600 dark:text-gray-300 text-sm">
        ...
        >
         ...
         on new ways to discover interpretable circuits in language models.
      </p>
      <p className="text-left text-gray-600 dark:text-gray-300 text-sm">
      ...
      <p className="text-left text-gray-600 dark:text-gray-300 text-sm">
        I also enjoy
        <a href="https://tmgps.org/" target="_blank" className="no-underline hover:underline text-gray-500 dark:text-green-400"> rowing my own gears</a>,
      ...
      {/* Add the ResearchProject component here */}
      <h2 className="text-lg font-bold dark:text-gray-300 mt-12">Recent Work</h2>
      <ResearchProject
      ...
      <div className="absolute inset-x-0 bottom-0">
        <p className="pb-4 text-center text-gray-400 dark:text-gray-300 text-xs">
