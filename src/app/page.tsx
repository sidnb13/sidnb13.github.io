  ...
  return (
    <div className="justify-center mx-auto px-8 py-12 max-w-screen-sm space-y-2 flex-grow">
      ...
      <p className="text-left text-gray-600 text-sm">
        ...
        > Automorphic (YC S23)</a>
        , building steerable, knowledgeable language models. I'm currently on leave
        from Georgia Tech, where I finished my first year studying Computer Science.
      </p>
      <p className="text-left text-gray-600 text-sm">
        In the past, I've interned at Oak Ridge exploring the intersection of graph
        learning and transformer models, and conducted research at Georgia Tech
        developing graph neural networks for materials science. I'm interested in
        deep learning theory &amp; systems.
      </p>
      <p className="text-left text-gray-600 text-sm">
        I have a{" "}
        <a
